...
public final class BeneficiaryData {
    ...
    public BeneficiaryData() {
        villageData.save();
        this.beneficiary = new Beneficiary(1000, "2895612450", "Porraz Vázcones", "Joaquin Porras", "Av los alamos", "0926754312", villageData.findById(), "Junto a la pista de hielo");
    }
