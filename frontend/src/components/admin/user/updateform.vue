  ...
  <form @submit.prevent="save">
    <div class="row">
      ...
      <div class="col s12 m10 ">
        <input type="text" class="browser-default"  required required v-model="user.dni" maxlength="10" minlength="10" placeholder="Ejm.:0812345678" pattern="[0-9]{10}" title="Un número de cédula válido debe tener 10 números.">
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col s12 m10 ">
        <input type="text" class="browser-default"  required required v-model="user.firstName">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col s12 m10 ">
        <input type="text" class="browser-default" required v-model="user.telephone" maxlength="10" minlength="7" placeholder="Ejm.: 2123456 o 032123456" pattern="[0-9]{10}{7}" title="Ingrese un teléfono válido">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col s12 m10 ">
        <select class="browser-default"  required v-model="user.roll">
    ...
    <div class="row">
      ...
      <div class="col s12 m10 ">
        <input type="text" class="browser-default"  required required v-model="user.address">
      </div>
    </div>
    <div class="row">
